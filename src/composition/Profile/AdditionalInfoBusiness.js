...
const AdditionalInfoBusiness = ({ user, handleSubmit }) => {
  ...
  const [isModifiable, setIsModifiable] = useState({ 
    ...
    general: user.name || user.rrn || user.address || user.address_postcode || user.address_detail ? false : true, 
        ...
        <AdditionalInfoRow>
          <AdditionalInfoColumns>
            <AdditionalInfoEditHeader
              ...
              handleToggleModify={() => {setIsModifiable( {...isModifiable, investHistory: !isModifiable.investHistory} )}}
        ...
        <AdditionalInfoRow>
          <AdditionalInfoColumns>
            <AdditionalInfoEditHeader
              ...
              handleToggleModify={() => {setIsModifiable( {...isModifiable, general: !isModifiable.general} )}}
            ...
            ? generalInformations.map((generalData, i) => {
                return (
                  <DescriptionLayer key={`general-${i}`}>
                    ...
                    <DescriptionColumnRight>
                      {generalData.value ?? `${generalData.labelKr} 입력이 필요합니다.`}
                    </DescriptionColumnRight>
                  </DescriptionLayer>
                ) 
              })
