...
const BusinessGeneralInformationInput = ({
  user = null,
  isReadonly,
  handleInputChange,
  options,
      ...
      <InfoRow>
        <InfoColumns>
          ...
          <Input
            ...
            onChange={(e) => {
              handleInputChange({ name: "rrn-back", value: e.target.value });
            }}
          />
        </InfoColumns>
      </InfoRow>
      <InfoRow>
        <InfoColumns>
          <Input
            ...
            onClick={
              !isReadonly ? options.handleClickToChangeAddress : undefined
            }
          />
          <Input
            type={"text"}
            ...
            value={user?.address ?? ""}
            onChange={(e) => {
              handleInputChange({ name: "address", value: e.target.value });
            }}
            onClick={
              !isReadonly ? options.handleClickToChangeAddress : undefined
            }
